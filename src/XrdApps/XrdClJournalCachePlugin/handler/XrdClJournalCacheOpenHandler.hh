...
class JournalCacheFile;

class JournalCacheOpenHandler : public XrdCl::ResponseHandler
// ---------------------------------------------------------------------- //
{
public:
  JournalCacheOpenHandler() : ready(false), pFile(nullptr), t2open(0) {}
  JournalCacheOpenHandler(XrdCl::JournalCacheFile *file)
      : ready(false), pFile(file), t2open(0) {
    creationTime = std::chrono::steady_clock::now();
  }

  virtual ~JournalCacheOpenHandler() {}
