...
function setup() {
	...
	openssl ca -batch -config tls.conf -in client.csr -extensions xrootd_usr_ext -notext -out client.crt
	...
	openssl ca -batch -config tls.conf -in invalid.csr -notext -out invalid.crt
	...
	openssl ca -batch -config tls.conf -in revoked.csr -extensions xrootd_usr_ext -notext -out revoked.crt
